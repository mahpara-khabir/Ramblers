	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
							<a href="index.php"  onclick="javascript:window.open('index.php','_self')"><img src="images/logo1.png" id="section-1" class="img-responsive" alt=""/></a>
						</div>
						<div class="menu">
						<ul id="nav">
                        ...
                        <li><a href="category.php" onclick="javascript:window.open('category.php','_self')">Category</a></li>
							 <li><a href="index.php#section-4"   onclick="javascript:window.open('index.php#section-4','_self')">                            Team Page</a></li>
