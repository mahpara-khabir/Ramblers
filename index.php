...
<div id="section-4" class="contact section">
   <div class="about-head text-center">
	  ...
	  <span></span><img src="images/guide.png" alt=""><span></span>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4><span class="icon1"></span>Mahpara Khabir</h4>
			 <p>ID:180104048</p>
                         <p>Home Town:Jashore</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4><span class="icon2"></span>Arifa Akter</h4>
			 <p>ID:180104050</p>
                         <p>Home Town:Narsingdi</p>
		 </div>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">Ramblers</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br/>
                        For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>01741171775</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">khabirmk98@gmail.com<br />arifaa1952@gmail.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Love road,Tejgaon,Dhaka</h5>
                        <br/>
